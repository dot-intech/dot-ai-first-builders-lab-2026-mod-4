...
- AC-28 (RF-28): Dado un usuario que está creando un nuevo registro de consumo a partir de una imagen, cuando el sistema ha estimado los alimentos en la imagen con un nivel de confianza de menos de 70%, entonces el sistema carga la información estimada pero obliga al usuario a editar manualmente la descripción y la cantidad de calorías del consumo.
